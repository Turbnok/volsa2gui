...
<div @click="close" class="container" v-if="!volsa||msg.length">
    ...
    <div :class="type" v-if="type=='infos'">        
        ...
        <h3>a gui for VolSa 2 by <a href="https://github.com/00nktk/volsa2" target="_blank">Nikita/00nkt</a></h3>
        <h4></h4>
        <div>
    ...
    <div :class="type" v-if="!volsa">Error : volsa2-cli is not installed or not in `/home/$USER/.cargo/bin/volsa2-cli`, please check <a @click="onVolsa">https://github.com/00nktk/volsa2</a> README.md</div>
</div>
</template>
